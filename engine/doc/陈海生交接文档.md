...
本文档为灵 (Ling) 项目的核心模块交接文档，涵盖以下六个关键模块：
...
### 📂 模块位置
```
engine/src/ling_engine/multi_user/
```
...
### 📂 模块位置
```
engine/src/ling_engine/database/
├── pgsql/          # PostgreSQL 相关
└── redis/          # Redis 相关
```
...
### 📂 模块位置
```
engine/src/ling_engine/emotion_system/
```
...
### 📂 模块位置
```
engine/src/ling_engine/important/
```

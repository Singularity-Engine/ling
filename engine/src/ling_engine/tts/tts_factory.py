    ...
    def get_tts_engine(engine_type, **kwargs) -> Type[TTSInterface]:
        if engine_type == "azure_tts":
            ...
            return ElevenLabsTTSEngine(
                ...
                optimize_streaming_latency=kwargs.get("optimize_streaming_latency", 0),
                voice_settings=kwargs.get("voice_settings"),
            )
        elif engine_type == "google_tts":
            from .google_tts import TTSEngine as GoogleTTSEngine

            return GoogleTTSEngine(
                project_id=kwargs.get("project_id"),
                credentials_json=kwargs.get("credentials_json"),
                voice_name=kwargs.get("voice_name", "en-US-Neural2-A"),
                language_code=kwargs.get("language_code", "en-US"),
                audio_encoding=kwargs.get("audio_encoding", "MP3"),
                sample_rate_hertz=kwargs.get("sample_rate_hertz", 24000),

...
def prepare_audio_payload(
    ...
    """
    # print(f"🎵 音频负载准备 - 收到Actions: {actions.to_dict() if actions else None}")
    ...
    if actions:
        ...
        # print(f"🎵 Actions转换为字典: {actions_dict}")

        # # 检查表情数据
        # if actions_dict and 'expressions' in actions_dict:
        #     print(f"✅ 发现表情数据: {actions_dict['expressions']}")
        # else:
        #     print(f"❌ 未发现表情数据")
    ...
    # print(f"🔊 完整音频负载准备完成: type={payload['type']}, actions={payload['actions']}")
    return payload

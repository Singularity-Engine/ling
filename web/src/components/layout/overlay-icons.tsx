/**
 * SVG icon constants for OverlayLayout.
 *
 * Extracted from OverlayLayout.tsx to keep the layout component focused
 * on structure and reduce JSX noise.
 */
...
export const ICON_CHEVRON_UP = (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="rgba(139,92,246,0.5)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">

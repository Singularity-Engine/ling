...
class SecurityConfig:
    ...
    jwt_issuer: str = "open-llm-vtuber-python"
    jwt_audience: str = "open-llm-vtuber-api"
...
class SecurityConfigManager:
    ...
    def _load_from_env(self) -> SecurityConfig:
        ...
        config = SecurityConfig(
            ...
            jwt_issuer=os.getenv('JWT_ISSUER', 'open-llm-vtuber-python'),
            jwt_audience=os.getenv('JWT_AUDIENCE', 'open-llm-vtuber-api'),
